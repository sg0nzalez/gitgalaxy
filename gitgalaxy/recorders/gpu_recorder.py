...
class GPURecorder:
    ...
    def record_mission(self, parsed_files: List[Dict], unparsable_files: List[Dict], summary: Dict, forensic_report: Dict, repo_name: str, commit_hash: str = "untracked_local", branch_name: str = "unknown_branch") -> Dict:
        """
        ...
        while parsed_files:
           ...
           # Vector Quantization (Flattened for WebGPU)
            columns["risks_flat"].extend([int(v * 10) for v in file_data.get("risk_vector", [0]*len(self.RISK_SCHEMA))])
