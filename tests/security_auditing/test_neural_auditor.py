...
def test_neural_auditor_safetensors_success(auditor, tmp_path):
    ...
    header_data = {
        ...
        "layer_0.weight": {"dtype": "F16", "shape": [4096, 4096], "data_offsets": [0, 33554432]}, # 16,777,216 params
        "layer_0.bias": {"dtype": "F16", "shape": [4096], "data_offsets": [33554432, 33562624]}   # 4,096 params
    }
...
def test_neural_auditor_gguf_success(auditor, tmp_path):
    ...
    binary_payload = b'GGUF\x02\x00\x00\x00' + b'\x88\x99\xAA\xBB' + b'model.architecture...mistral...quantization...Q4_K'
